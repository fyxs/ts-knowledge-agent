...
$logDir = Join-Path $env:LOCALAPPDATA 'ts-team-knowledge-agent\logs'
...
$env:TS_KB_KNOWLEDGE_REPO = if ($env:TS_KB_KNOWLEDGE_REPO) { $env:TS_KB_KNOWLEDGE_REPO } else { Join-Path $env:LOCALAPPDATA 'ts-team-knowledge-agent\knowledge-base\ts-team-knowledge-base' }
Set-Location $root
